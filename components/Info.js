      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles["grid-1"]}>
            ...
            <p>
              Впечатление можно отменить в течение 24 часов после оплаты или за
              7 дней до начала и получить полный возврат
            </p>
            <a href="#">Подробнее &gt;</a>
          </div>
          ...
          <div className={styles["grid-3"]}>
            ...
            <p>
              ...
              доступны только гостям, достигшим возраста официально разрешённого
